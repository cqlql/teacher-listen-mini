import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{i as s}from"./app.6e3b70d2.js";const a={},p=s(`<h2 id="classify-\u5206\u7C7B" tabindex="-1"><a class="header-anchor" href="#classify-\u5206\u7C7B" aria-hidden="true">#</a> classify \u5206\u7C7B</h2><div class="language-typescript ext-ts line-numbers-mode"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">LessonScoreItem</span> <span class="token punctuation">{</span>
